...
const updateStats = () => {
    ...
    if (elements.highPriorityTasks) elements.highPriorityTasks.textContent = stats.high;
    if (elements.completedTasks) elements.completedTasks.textContent = stats.completed;
    if (elements.inProgressTasks) elements.inProgressTasks.textContent = stats.active;
};
